...
Key references:
- @{{GSD_PLUGIN_ROOT}}/gsd-core/references/ui-brand.md (display patterns)
- @{{GSD_PLUGIN_ROOT}}/agents/gsd-user-profiler.md (profiler agent definition)
- @{{GSD_PLUGIN_ROOT}}/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="{{GSD_PLUGIN_ROOT}}/gsd-core/USER-PROFILE.md"
...
```bash
cp "{{GSD_PLUGIN_ROOT}}/gsd-core/USER-PROFILE.md" "$HOME/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at {{GSD_PLUGIN_ROOT}}/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `{{GSD_PLUGIN_ROOT}}/gsd-core/references/user-profiling.md`
...
Reference: @{{GSD_PLUGIN_ROOT}}/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to {{GSD_PLUGIN_ROOT}}/gsd-core/USER-PROFILE.md"
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at {{GSD_PLUGIN_ROOT}}/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Your profile:    {{GSD_PLUGIN_ROOT}}/gsd-core/USER-PROFILE.md
```

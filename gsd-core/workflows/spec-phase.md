...
ones). Reference: @{{GSD_PLUGIN_ROOT}}/gsd-core/references/edge-probe.md.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "{{GSD_PLUGIN_ROOT}}/gsd-core/bin/lib/edge-probe.cjs" \
...
requirement list). Reference: @{{GSD_PLUGIN_ROOT}}/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @{{GSD_PLUGIN_ROOT}}/gsd-core/templates/spec.md.

...
Read and execute: `{{GSD_PLUGIN_ROOT}}/gsd-core/references/autonomous-ui-design-contract.md`
...
On "All good — continue": set VERIFICATION frontmatter `status: passed`, display `Phase ${PHASE_NUM} ✅ Human validation passed`, run `@{{GSD_PLUGIN_ROOT}}/gsd-core/workflows/transition.md`, then iterate.
...
Read and execute: `{{GSD_PLUGIN_ROOT}}/gsd-core/references/autonomous-smart-discuss.md`

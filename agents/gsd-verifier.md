...
<required_reading>
@{{GSD_PLUGIN_ROOT}}/gsd-core/references/verification-overrides.md
@{{GSD_PLUGIN_ROOT}}/gsd-core/references/gates.md
@{{GSD_PLUGIN_ROOT}}/gsd-core/references/verifier-phase-gates.md
@{{GSD_PLUGIN_ROOT}}/gsd-core/references/verifier-evidence-gate.md
</required_reading>
...
@{{GSD_PLUGIN_ROOT}}/gsd-core/references/thinking-models-verification.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@{{GSD_PLUGIN_ROOT}}/gsd-core/references/verify-mvp-mode.md`.
